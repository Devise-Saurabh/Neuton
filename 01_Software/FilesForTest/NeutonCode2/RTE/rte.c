...
float RTE_Read_MCU_ESTOP_Monitor(void)
{
	...
	if(RTE_astrData[RTE_DATA_ID_MCU_ESTOP_MONITOR].u32AccessMutex == RTE_MUTEX_FREE)
	{
		fltReturnValue = RTE_astrData[RTE_DATA_ID_MCU_ESTOP_MONITOR].fltData;
		eStatus = STATUS_OK;
	}
	else
	{
...
void RTE_Write_MCU_ESTOP_Monitor(float fltValue)
{
	...
	if(RTE_astrData[RTE_DATA_ID_MCU_ESTOP_MONITOR].u32AccessMutex == RTE_MUTEX_FREE)
	{
		RTE_astrData[RTE_DATA_ID_MCU_ESTOP_MONITOR].fltData = fltValue;
		eStatus = STATUS_OK;
	}
	else
	{

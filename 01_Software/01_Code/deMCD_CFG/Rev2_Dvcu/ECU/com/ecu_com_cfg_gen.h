...
#define ECU_COM_RX1_SIGNALS_NUM                                            (0)
...
#define ECU_COM_RX_SIGNALS_NUM                                             (17)
#define APP_RX_COMMANDMODE_MCUCMD1RES                                      (0)
#define APP_RX_HV_SYSTEM_VOLTAGE                                           (1)
#define APP_RX_MAXSAFEMOTORSPEEDFORWARD                                    (2)
#define APP_RX_MAXSAFEMOTORSPEEDFORWARDSTATUS                              (3)
#define APP_RX_MAXSAFEMOTORSPEEDREVERSE                                    (4)
#define APP_RX_MAXSAFEMOTORSPEEDREVERSESTATUS                              (5)
#define APP_RX_MOTOR_SPEED                                                 (6)
#define APP_RX_OPERATIONALMODE_MCUCMD1RES                                  (7)
#define APP_RX_REGENDERATING                                               (8)
#define APP_RX_REGENDERATINGSTATUS                                         (9)
#define APP_RX_ROLLINGCOUNTER_MCUCMD1RESPONSE                              (10)
#define APP_RX_STATEMCU                                                    (11)
#define APP_RX_TRACTIONDERATING                                            (12)
#define APP_RX_TRACTIONDERATINGSTATUS                                      (13)
#define APP_RX_TRACTION_BATTERY_CURRENT                                    (14)
#define APP_RX_TRACTION_BATTERY_SOC                                        (15)
#define APP_RX_TRAS_CURRENT_RANGE                                          (16)
...
#define APP_TX_CAN1                                                        (25)
#define APP_TX_CAN2                                                        (26)
#define APP_TX_CAN3                                                        (27)

...
{
  {
    ...
    deMCD_DEFAULT,    	
    /*Frequency Value*/
    ECU_IO_POUT_TCS_RadFAN_P59_DEFAULT_FREQ,
    /*DutyCycle Value*/
    ECU_IO_POUT_TCS_RadFAN_P59_DEFAULT_DUTY
  },
  {
    /*PWM Object Id*/
    Noname_Pin_P23,

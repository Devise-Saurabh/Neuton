...
#include "app_Main1msMgr.h"            /* Model's header file */
#include "rtwtypes.h"
 ...
 * app_Main1msMgr_fcn
 */
extern void sample_usage_app_Main1msMgr_fcn(void);
void sample_usage_app_Main1msMgr_fcn(void)
{
  /*
...
int_T main(int_T argc, const char *argv[])
{
   ...
   * after this step.
   */
  while (rtmGetErrorStatus(app_Main1msMgr_M) == (NULL)) {
